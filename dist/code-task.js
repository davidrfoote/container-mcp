    ...
    (async () => {
        try {
            ...
            const proc = (0, child_process_1.spawn)("claude", claudeArgs, {
                cwd: workingDir, env: { ...process.env, PATH: `/usr/bin:/usr/local/bin:${process.env.PATH ?? ""}`, CLAUDECODE: undefined, CLAUDE_CODE_ENTRYPOINT: undefined }, stdio: ["ignore", "pipe", "pipe"],
            });
